              ...
              <div id="unsubscribe" class="col-sm-9 col-md-8">
                  ...
                  <div  class="social_share">
                    ...
                    <ul class="social social--simple">
                      ...
                      <li><a href="http://twitter.com/share?text=<?=$post['post_title']?>&url=<?=Yii::$app->urlManager->hostInfo.Url::to([$page['url'].'/'.$post['post_url']])?>" target="_blank" class="social__item"><i class="icon icon--tw"></i></a></li>
                    </ul>
                  </div>
              </div>
