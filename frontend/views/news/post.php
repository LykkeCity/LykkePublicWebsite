            ...
            <div class="row">
              ...
              <div id="unsubscribe" class="col-sm-9 col-md-8">
                  <div class="news_article__text text">
                   ...
                   <?=SocialShareInnerPost::widget(['page_url' => $page['url'], 'post_url' => $post['post_url'], 'post_title' => $post['post_title'], 'picture' => Yii::$app->request->hostInfo.'/media/news/'.$post['post_img']])?>
              </div>
