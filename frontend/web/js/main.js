...
;(function(window) {
	...
	GridFx.prototype._openItem = function(ev, item) {
		...
		this.cloneImg.style.MozTransform = 'translate3d(' + dx + 'px, ' + dy + 'px, 0) scale3d(' + z + ', ' + z + ', 1)';
		...
		onEndTransition(this.cloneImg, function() {
			...
			imagesLoaded(self.originalImg, function() {
				...
				onEndTransition(self.originalImg, function() {
					...
					self.cloneImg.style.MozTransform = 'translate3d(0,0,0) scale3d(1,1,1)';
	...
	GridFx.prototype._setOriginal = function(src) {
		if( !src ) {
			...
			this.originalImg.style.MozTransform = 'translate3d(0,0,0) scale3d(1,1,1)';
	...
	GridFx.prototype._closeItem = function() {
		...
		this.originalImg.style.MozTransform = 'translate3d(' + dx + 'px, ' + dy + 'px, 0) scale3d(' + z + ', ' + z + ', 1)';
		...
		onEndTransition(this.originalImg, function() {
			...
			onEndTransition(self.originalImg, function() {
				...
				self.originalImg.style.MozTransform = 'translate3d(0,0,0) scale3d(1,1,1)';
