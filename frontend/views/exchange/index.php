      ...
      <div class="row">
        ...
        <div class="col-sm-10 col-md-8 automargin">
          ...
          <div class="table-header">
            ...
            <ul class="nav nav-tabs" role="tablist">
              <? foreach ($assets as $asset) {?>
                  <li role="presentation" class="<?=$asset === reset($assets) ? 'active' : ''?>"><a href="#tab_<?=$asset['name']?>" aria-controls="tab_<?=$asset['name']?>" role="tab" data-toggle="tab"><?=$asset['name']?></a></li>
              <? } ?>
            </ul>
          </div>
          ...
          <div class="tab-content">
            ...
            <? foreach ($assets as $asset) {?>
              <div role="tabpanel" class="tab-pane <?=$asset === reset($assets) ? 'active' : ''?>" id="tab_<?=$asset['name']?>">
                <div class="table-responsive" id="RatesTable<?=$asset['name']?>">
