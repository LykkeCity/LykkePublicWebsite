...
<!--    --><?//=SubMenu::widget(); ?>
    ...
    <script type="text/javascript">
      /* <![CDATA[ */
      var google_conversion_id = 976584301;
    ...
    <noscript>
      <div style="display:inline;">
        <img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/976584301/?guid=ON&amp;script=0"/>
      </div>
    </noscript>
    <style>
