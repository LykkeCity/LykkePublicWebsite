      ...
      <div class="row">
        <div class="col-sm-8 automargin">
          ...
          <p class="lead text-left ">Simply stated, the same efficiencies that
            ...
            business. We can help you to unlock the potential of the digital age
            with minimal
          ...
          <p class="lead text-left ">Lykke Accelerator puts our team of
            ...
            group. Together, we can help your company to compete more
            effectively, seize new opportunities, and realize huge savings.</p>

          <h3 class="h2">What we can do for your business</h3>
          <h4 style="margin-top: -20px;">Example turn-key applications</h4>
        </div>
      </div>
    </div>
        ...
        <div id="collapseOne" class="panel_collapse collapse" role="tabpanel"
          ...
          <div class="panel_body">
            <div class="container container--extend">
              <div class="row">
                <div class="col-sm-8 automargin">
                  <p>Banks are well positioned to issue and exchange digital
                    assets. Your bank could be a custodian for securities or
                    simply a gateway for on-demand deposits. At Lykke, we are
                    committed to helping banks digitize their core processes and
                    make new business on the Blockchain.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="collapseTwo" class="panel_collapse collapse" role="tabpanel"
          ...
          <div class="panel_body">
            <div class="container container--extend">
              <div class="row">
                <div class="col-sm-8 automargin">
                  <p>Crowdlending platforms are constrained by the cash holding
                    period, which makes the loan fulfillment process a bumpy
                    road. Significant costs arise during all cash movements,
                    especially during the distribution of installment payments.
                    Lykke helps to move the cash leg onto the Blockchain, issue
                    and allocate claim tokens for each loan, distribute
                    installment payments to the claimholders for a trivial cost,
                    and—cruicially—organize a secondary market for the claims,
                    which could become a unique selling point for your p2p
                    lending platform.</p>
                </div>
              </div>
            </div>
        ...
        <div id="collapse3" class="panel_collapse collapse" role="tabpanel"
          ...
          <div class="panel_body">
            <div class="container container--extend">
              <div class="row">
                <div class="col-sm-8 automargin">
                  <p>Industry consortiums and large international holdings face
                    complicated cash settlement processes with significant funds
                    moving across borders. To optimize the clearing procedure,
                    Lykke can show you how to design a platform based on
                    Settlement Coin, which can massively speed up the payments
                    for services provided by a multitude of consortium or
                    holding members.</p>
                </div>
              </div>
            </div>
        ...
        <div id="collapse5" class="panel_collapse collapse" role="tabpanel"
          ...
          <div class="panel_body">
            <div class="container container--extend">
              <div class="row">
                <div class="col-sm-8 automargin">
                  <p>As IoT devices become smarter, they integrate into networks
                    of interacting heterogenous agents. We are working on
                    embedding our wallet technology into IoT devices to enable
                    low-value transactions, where one or both parties are
                    potential actors in a true Economy of Things.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div id="collapse6" class="panel_collapse collapse" role="tabpanel"
          ...
          <div class="panel_body">
            <div class="container container--extend">
              <div class="row">
                <div class="col-sm-8 automargin">
                  <p>The Lykke platform provides the potential to develop
                    Blockchain-based loyalty cards, which offer an immutable,
                    accurate, and transparent record of the holder’s current
                    loyalty points.</p>
                </div>
              </div>
            </div>
        ...
        <div id="collapse7" class="panel_collapse collapse" role="tabpanel"
          ...
          <div class="panel_body">
            <div class="container container--extend">
              <div class="row">
                <div class="col-sm-8 automargin">
                  <p>With Lykke, you can create unique, branded, event-specific
                    currency for your clients. Participants can use this
                    currency to purchase access or tickets to the event, buy
                    memorabilia or merchandise from all event vendors, and
                    settle all related payments.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="toggled_form hide" id="accelerate_form">
        ...
        <form action="https://service.capsulecrm.com/service/newlead"
          ...
          <input type="hidden" name="COMPLETE_URL"
                 value="http://lykke.com/b2b-thanks">
