...
<div  class="social_share">
  ...
  <ul class="social social--simple">
    <li><a href="https://www.facebook.com/sharer.php?u=<?=Yii::$app->urlManager->hostInfo.Url::to([$page_url.'/'.$post_url])?>" target="_blank" class="social__item"><i class="icon icon--fb_simple"></i></a></li>
