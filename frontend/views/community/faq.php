                    ...
                    <div class="text">
                        <div class="inline-edit" data-page-id="9">
                                <h1 id="frequently_asked_questions"
                                    class="sectionedit1 page-header">Frequently
                                    Asked Questions</h1>
                                <div class="level1">&nbsp;</div>
                                <h2 id="about_lykke" class="sectionedit2">About
                                    Lykke</h2>
                                <div class="level2">&nbsp;</div>
                                <h3 id="what_is_lykke" class="sectionedit3">What
                                    is Lykke?</h3>
                                <div class="level3">
                                ...
                                <h3 id="what_kind_of_company_is_lykke"
                                    class="sectionedit4">What kind of company is
                                    Lykke?</h3>
                                <div class="level3">
                                ...
                                <h3 id="how_does_operate_lykke_structurally_as_an_intermediary_as_a_gateway_a_oanda_or_fx_between_cryptocurrency_and_forex"
                                    class="sectionedit5">How does operate Lykke
                                ...
                                <h3 id="how_lykke_intersects_with_the_banking_system_to_make_its_own_function"
                                    class="sectionedit6">How Lykke intersects
                                ...
                                <h3 id="we_are_talking_of_a_securities_firm_in_cryptocurrency"
                                    class="sectionedit7">We are talking of a
                                ...
                                <h3 id="what_is_the_business-model"
                                    class="sectionedit8">What is the
                                    business-model?</h3>
                                <div class="level3">
                                ...
                                <h3 id="why_uk_for_licensing_mtf"
                                    class="sectionedit9">Why UK for licensing
                                    MTF?</h3>
                                <div class="level3">
                                ...
                                <h3 id="what_are_the_regulatory_requirements_to_acquire_this_license"
                                    class="sectionedit10">What are the
                                ...
                                <h3 id="if_lykke_is_open_sourced_won_t_some_competing_company_just_come_in_and_copy_and_replicate"
                                    class="sectionedit11">If Lykke is open
                                ...
                                <h2 id="blockchain_tech" class="sectionedit12">
                                    Blockchain tech</h2>
                                <div class="level2">&nbsp;</div>
                                <h3 id="does_lykke_build_a_blockchain"
                                    class="sectionedit13">Does Lykke build a
                                    blockchain?</h3>
                                <div class="level3">
                                ...
                                <h3 id="could_lykke_use_theoretically_any_other_blockchain"
                                    class="sectionedit14">Could Lykke use
                                    theoretically any other Blockchain?</h3>
                                <div class="level3">
                                    <p>Blockchains that support issued coins,
                                        yes. In practice not all implementations
                                        make sense.</p>
                                </div>
                                <h3 id="how_dependent_is_lykke_on_bitcoin"
                                    class="sectionedit15">How dependent is Lykke
                                    on Bitcoin?</h3>
                                <div class="level3">
                                ...
                                <h3 id="could_the_blocksize_limit_become_a_problem_for_lykke"
                                    class="sectionedit16">Could the blocksize
                                ...
                                <h2 id="lykke_wallet" class="sectionedit17">
                                    Lykke wallet</h2>
                                <div class="level2">&nbsp;</div>
                                <h3 id="where_can_i_download_a_lykke_wallet"
                                    class="sectionedit18">Where can I download a
                                    Lykke wallet?</h3>
                                <div class="level3">
                                ...
                                <h3 id="what_if_my_coins_are_stolen"
                                    class="sectionedit19">What if my coins are
                                    stolen?</h3>
                                <div class="level3">
                                ...
                                <h3 id="can_i_store_my_coins_in_any_bitcoin_wallet"
                                    class="sectionedit20">Can I store my coins
                                ...
                                <h3 id="can_i_send_the_coins_from_my_lykke_mobile_wallet_to_my_coinprism_wallet"
                                    class="sectionedit21">Can I send the coins
                                ...
                                <h3 id="is_it_safe_to_keep_my_lykke_coins_in_my_lykke_wallet_long-term"
                                    class="sectionedit22">Is it safe to keep my
                                ...
                                <h3 id="is_it_possible_to_use_the_wallet_to_do_an_offline_cold_storage"
                                    class="sectionedit23">Is it possible to use
                                ...
                                <h2 id="ico" class="sectionedit24">ICO</h2>
                                <div class="level2">&nbsp;</div>
                                <h3 id="what_is_ico" class="sectionedit25">What
                                    is ICO?</h3>
                                <div class="level3">
                                ...
                                <h3 id="what_are_these_coins_exactly&#8202;_&#8202;bitcoins"
                                    class="sectionedit26">What are these coins,
                                    exactly&#8202;—&#8202;Bitcoins?</h3>
                                <div class="level3">
                                ...
                                <h3 id="is_lkk_a_currency_or_a_stock"
                                    class="sectionedit27">Is LKK a currency or a
                                    stock?</h3>
                                <div class="level3">
                                ...
                                <h3 id="are_there_two_classes_of_stock"
                                    class="sectionedit28">Are there two classes
                                    of stock?</h3>
                                <div class="level3">
                                ...
                                <h3 id="are_lykke_coins_divisible"
                                    class="sectionedit29">Are Lykke coins
                                    divisible?</h3>
                                <div class="level3">
                                ...
                                <h3 id="how_did_you_arrive_at_the_ico_valuation"
                                    class="sectionedit30">How did you arrive at
                                ...
                                <h3 id="can_i_still_purchase_lykke_coins_after_the_ico"
                                    class="sectionedit31">Can I still purchase
                                ...
                                <h3 id="can_i_use_my_existing_bitcoin_wallet"
                                    class="sectionedit32">Can I use my existing
                                    Bitcoin wallet?</h3>
                                <div class="level3">
                                ...
                                <h3 id="are_there_any_fees"
                                    class="sectionedit33">Are there any
                                    fees?</h3>
                                <div class="level3">
                                ...
                                <h2 id="owning_lykke_coins"
                                    class="sectionedit34">Owning Lykke
                                    Coins</h2>
                                <div class="level2">&nbsp;</div>
                                <h3 id="what_is_the_exchange_rate_of_1_lkk_as_of_now"
                                    class="sectionedit35">What is the exchange
                                ...
                                <h3 id="do_my_coins_have_voting_rights"
                                    class="sectionedit36">Do my coins have
                                    voting rights?</h3>
                                <div class="level3">
                                ...
                                <h3 id="if_i_have_lykke_coins_am_i_considered_to_be_a_shareholder_of_lykke_corp"
                                    class="sectionedit37">If I have Lykke coins
                                ...
                                <h3 id="why_is_the_kyc_process_required"
                                    class="sectionedit38">Why is the KYC process
                                    required?</h3>
                                <div class="level3">
                                ...
                                <h3 id="would_my_personal_information_be_safe_after_kyc_process_i_don_t_want_my_passport_to_become_available_in_the_internet_one_day"
                                    class="sectionedit39">Would my personal
                                ...
                                <h3 id="if_i_own_100_or_more_coins_will_i_receive_share_certificates"
                                    class="sectionedit40">If I own 100 or more
                                ...
                                <h3 id="will_the_coins_pay_dividends"
                                    class="sectionedit41">Will the coins pay
                                    dividends?</h3>
                                <div class="level3">
                                ...
                                <h3 id="can_the_value_of_the_coins_be_diluted"
                                    class="sectionedit42">Can the value of the
                                    coins be diluted?</h3>
                                <div class="level3">
                                ...
                                <h3 id="could_there_be_a_problem_with_liquidity"
                                    class="sectionedit43">Could there be a
                                ...
                                <h3 id="will_the_company_publish_reports"
                                    class="sectionedit44">Will the company
                                    publish reports?</h3>
                                <div class="level3">
                                ...
                                <h3 id="will_there_be_an_annual_shareholder_meeting"
                                    class="sectionedit45">Will there be an
                                    annual shareholder meeting?</h3>
                                <div class="level3">
                                ...
                                <h3 id="how_can_i_best_keep_up_with_lykke_developments"
                                    class="sectionedit46">How can I best keep up
                                ...
                                <h3 id="how_do_i_sell_my_coins"
                                    class="sectionedit47">How do I sell my
                                    coins?</h3>
                                <div class="level3">
                                    <p>Just put in a sell order using an
                                        Exchange page at your Lykke Wallet.</p>
                                </div>
                                <h3 id="what_s_the_total_supply_of_lykke_coins"
                                    class="sectionedit48">What's the total
                                ...
                                <h3 id="in_which_situations_can_the_number_of_lykke_coins_increase_again"
                                    class="sectionedit49">In which situations
                                ...
                                <h1 id="other_questions"
                                    class="sectionedit50 page-header">Other
                                    questions</h1>
                                <div class="level1">&nbsp;</div>
                                <h2 id="how_does_lykke_earn_money"
                                    class="sectionedit51">How does Lykke earn
                                    money?</h2>
                                <div class="level2">
                                ...
                                <h2 id="when_will_lykke_become_profitable"
                                    class="sectionedit52">When will Lykke become
                                    profitable?</h2>
                                <div class="level2">
                                ...
                                <h2 id="what_is_the_unique_selling_proposition_of_lykke"
                                    class="sectionedit53">What is the unique
                                ...
                                <h2 id="how_does_lykke_differ_from_the_other_crypto-ventures"
                                    class="sectionedit54">How does Lykke differ
                                ...
                                <h2 id="what_is_the_history_of_lykke"
                                    class="sectionedit55">What is the history of
                                    Lykke?</h2>
                                <div class="level2">
                                ...
                                <h2 id="why_is_our_matching_engine_price_spread_and_time_based"
                                    class="sectionedit56">Why is our matching
                                ...
                                <h2 id="why_does_the_lykke_marketplace_have_an_intraday_yield_curve"
                                    class="sectionedit57">Why does the Lykke
                                ...
                                <h2 id="why_does_lykke_rely_on_open_source_software"
                                    class="sectionedit58">Why does Lykke rely on
                                ...
                                <h2 id="why_does_lykke_operate_as_a_crowd-based_company"
                                    class="sectionedit59">Why does Lykke operate
                                ...
                                <h2 id="how_can_i_participate_in_the_lykke_movement"
                                    class="sectionedit60">How can I participate
                                ...
                                <h2 id="why_is_kyc_information_required_to_become_a_citizen"
                                    class="sectionedit61">Why is KYC information
                                ...
                                <h2 id="why_do_we_have_honorary_citizens"
                                    class="sectionedit62">Why do we have
                                ...
                                <h2 id="why_is_lykke_a_commercial_enterprise"
                                    class="sectionedit63">Why is Lykke a
                                ...
                                <h2 id="what_are_the_long-term_plans_of_richard_the_major_shareholder"
                                    class="sectionedit64">What are the long-term
                                ...
                                <h2 id="what_is_a_lykke_coin"
                                    class="sectionedit65">What is a Lykke
                                    coin?</h2>
                                <div class="level2">
                                ...
                                <h2 id="why_do_we_make_our_payments_with_lykke_coins"
                                    class="sectionedit66">Why do we make our
                                ...
                                <h2 id="will_the_price_of_lykke_coins_change_over_time"
                                    class="sectionedit67">Will the price of
                                ...
                                <h2 id="why_did_we_choose_the_name_lykke"
                                    class="sectionedit68">Why did we choose the
                                    name Lykke?</h2>
                                <div class="level2">
                                ...
                                <h2 id="what_is_the_distributed_ledger_technology"
                                    class="sectionedit69">What is the
                                ...
                                <h2 id="why_is_the_distributed_ledger_technology_so_disruptive"
                                    class="sectionedit70">Why is the distributed
                                ...
                                <h2 id="why_is_direct_ownership_so_important"
                                    class="sectionedit71">Why is direct
                                ...
                                <h2 id="how_will_the_financial_industry_change"
                                    class="sectionedit72">How will the financial
                                    industry change?</h2>
                                <div class="level2">
                                ...
                                <h2 id="what_are_colored_coins"
                                    class="sectionedit73">What are colored
                                    coins?</h2>
                                <div class="level2">
                                ...
                                <h2 id="what_is_the_difference_between_colored_coin_and_bitcoin"
                                    class="sectionedit74">What is the difference
                                ...
                                <h2 id="how_does_the_lykke_marketplace_function"
                                    class="sectionedit75">How does the Lykke
                                ...
                                <h2 id="how_is_the_lykke_development_process_organized"
                                    class="sectionedit76">How is the Lykke
                                ...
                                <h2 id="how_to_use_lykke_wiki_engine"
                                    class="sectionedit77">How to use Lykke Wiki
                                    Engine?</h2>
                                <div class="level2">
                                    <p>See Welcome to Lykke Wiki.</p>
                                </div>
                                <h2 id="what_is_the_bitcoin_refund_transaction"
                                    class="sectionedit78">What is the bitcoin
                                ...
                                <h2 id="what_means_semi-centrlized_exchange"
                                    class="sectionedit79">What means
