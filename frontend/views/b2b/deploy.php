    ...
    <div class="panel panel--accordion">
      ...
      <div id="collapse5" class="panel_collapse collapse" role="tabpanel"
        ...
        <div class="panel panel--accordion">
          ...
          <div id="collapse5" class="panel_collapse collapse"
               role="tabpanel"
               aria-labelledby="heading5">
            <div class="panel_body">
              <div class="container container--extend">
                <div class="row">
                  <div class="col-sm-8 automargin">
                    <p>As IoT devices become smarter, they integrate into
                      networks
                      of interacting heterogenous agents. We are working on
                      embedding our wallet technology into IoT devices to
                      enable
        ...
        <div class="panel panel--accordion">
          ...
          <div id="collapse6" class="panel_collapse collapse"
              ...
              <div id="collapse6" class="panel_collapse collapse"
                ...
                <div class="panel_body">
                  <div class="container container--extend">
                    <div class="row">
                      <div class="col-sm-8 automargin">
                        <p>The Lykke platform provides the potential to
                          develop
                          Blockchain-based loyalty cards, which offer an
                          immutable,
                          accurate, and transparent record of the holder’s
                          current
                          loyalty points.</p>
                        >>>>>>> master
                      </div>
            ...
            <div class="panel panel--accordion">
              ...
              <div id="collapse7" class="panel_collapse collapse"
                  ...
                  <div id="collapse7" class="panel_collapse collapse"
                    ...
                    <div class="panel_body">
                      <div class="container container--extend">
                        <div class="row">
                          <div class="col-sm-8 automargin">
                            <p>With Lykke, you can create unique, branded,
                              event-specific
                              currency for your clients. Participants can
                              use this
                              currency to purchase access or tickets to the
                              event, buy
                              memorabilia or merchandise from all event
                              vendors, and
              ...
              <div class="container container--extend">
                <div class="text-center">
                  <button class="btn btn--primary btn_show_form"
                          data-target="#accelerate_form" type="button">
                    Accelerate me
                  </button>
                </div>
                ...
                <div class="toggled_form hide" id="accelerate_form">
                  ...
                  <form
                      ...
                      method="post"
                      class="form form_accelerate form--simple">
                    ...
                    <div class="form-group">
                      <label for="salutation"
                             class="control-label">Salutation*</label>
                    ...
                    <div class="form-group">
                      <label for="website"
                             class="control-label">Website</label>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <label for="hear" class="control-label">Where did
                          you hear about
                          us?</label>
                      </div>
                      <div class="col-sm-8">
                        <div class="form-group">
                          <div class="radio">
                            <input type="radio" name="temp-lead" id="hear1"
                                   value="Event"
                          ...
                          <div class="radio">
                            <input type="radio" name="temp-lead" id="hear2"
                                   ...
                                   class="radio__control">
                            <label for="hear2"
                                   class="control-label radio__label">www.lykke.com</label>
                          </div>
                          <div class="radio">
                            <input type="radio" name="temp-lead" id="hear3"
                                   ...
                                   class="radio__control">
                            <label for="hear3"
                                   class="control-label radio__label">Personal
                              network</label>
                          </div>
                          <div class="radio">
                            <input type="radio" name="temp-lead" id="hear4"
                                   value="Other"
                                   class="radio__control">
                            <label for="hear4"
                    ...
                    <select class="hidden" id="physics_lead"
                      ...
                      <option value="Personal network">personal Network
                      </option>
                      <option value="Other">other</option>
                    </select>

                    <div class="form-group">
                      <label for="solution" class="control-label">What
                        solution you are
                        looking for to realize with Lykke (if you are a
                        Lykke team member,
                        please include your Lykke email here)*</label>
                      <textarea name="CUSTOMFIELD[Request_Description]"
                                id="solution"
                                maxlength="250"
